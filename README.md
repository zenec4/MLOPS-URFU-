...
- Для развёртывания приложения клонируйте репозиторий и перейдите в папку lab1
  
- Для того, чтобы запустить данный скрипт, в линуксе нужно прописать следующую команду: ./pipeline.sh

- Заранее в папке пропишите права для того, чтобы запустить данный скрипт: chmod +x pipeline.sh
</details>
